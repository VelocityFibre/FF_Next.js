        ...
        <div className="space-y-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-start space-x-3">
              <div className="w-8 h-8 bg-[var(--ff-surface-secondary)] rounded-full"></div>
              <div className="flex-1 space-y-2">
                <div className="h-4 bg-[var(--ff-surface-secondary)] rounded w-3/4"></div>
                <div className="h-3 bg-[var(--ff-surface-secondary)] rounded w-1/2"></div>
              </div>
            </div>
          ))}
        </div>
