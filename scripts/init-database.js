...
async function initializeDatabase() {
  ...
  try {
    ...
    console.log('✓ SOW Poles table ready');
    ...
    console.log('✓ SOW Drops table ready');
    ...
    console.log('✓ SOW Fibre table ready');
    ...
    console.log(`- SOW Poles: ${polesCount.count}`);
    console.log(`- SOW Drops: ${dropsCount.count}`);
    console.log(`- SOW Fibre: ${fibreCount.count}`);
